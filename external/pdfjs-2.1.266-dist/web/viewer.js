                ...
                case 0:
                  ...
                  if (values.page && viewOnLoad !== ViewOnLoad.INITIAL) {
                    ...
                    if (spreadMode === _ui_utils.SpreadMode.UNKNOWN) {
                      spreadMode = values.spreadMode | 2;
                    }
                  }
...
var defaultOptions = {
 ...
 // added by samuel n default was -1
  scrollModeOnLoad: {
    value: 3,
    kind: OptionKind.VIEWER
  },
...
function getDefaultPreferences() {
  if (!defaultPreferences) {
    defaultPreferences = Promise.resolve({
      ...
      "scrollModeOnLoad": -1,
	// added by samuel nwokenkwo, this was what actually allowed spread mode on loading of website
      "spreadModeOnLoad": 2
    });
  }
